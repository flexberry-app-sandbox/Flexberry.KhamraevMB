...
moduleForModel('i-i-s-khamraev-m-b-запись-в-накладной', 'Unit | Serializer | i-i-s-khamraev-m-b-запись-в-накладной', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-khamraev-m-b-запись-в-накладной',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
