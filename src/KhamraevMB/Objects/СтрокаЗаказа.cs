...
namespace IIS.KhamraevMB
{
    ...
    public class СтрокаЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KhamraevMB.Заказ fЗаказ;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.KhamraevMB.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.KhamraevMB.Заказ Заказ
        {
            get
            {
                ...
                IIS.KhamraevMB.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СтрокаЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СтрокаЗаказаE", typeof(IIS.KhamraevMB.СтрокаЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСтрокаЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.KhamraevMB.DetailArrayOfСтрокаЗаказа members)

        // *** End programmer edit section *** (IIS.KhamraevMB.DetailArrayOfСтрокаЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfСтрокаЗаказа(IIS.KhamraevMB.Заказ fЗаказ) : 
                base(typeof(СтрокаЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.KhamraevMB.СтрокаЗаказа this[int index]
        {
            get
            {
                return ((IIS.KhamraevMB.СтрокаЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.KhamraevMB.СтрокаЗаказа dataobject)
        {
