...
namespace IIS.KhamraevMB
{
    ...
    public class ЗаписьВНакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KhamraevMB.Накладная fНакладная;
        ...
        [PropertyStorage(new string[] {
                "Товар"})]
        [NotNull()]
        public virtual IIS.KhamraevMB.Товар Товар
        {
            get
            {
                ...
                IIS.KhamraevMB.Товар result = this.fТовар;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.KhamraevMB.Накладная.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Накладная"})]
        public virtual IIS.KhamraevMB.Накладная Накладная
        {
            get
            {
                ...
                IIS.KhamraevMB.Накладная result = this.fНакладная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьВНакладнойE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьВНакладнойE", typeof(IIS.KhamraevMB.ЗаписьВНакладной));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЗаписьВНакладной : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.KhamraevMB.DetailArrayOfЗаписьВНакладной members)

        // *** End programmer edit section *** (IIS.KhamraevMB.DetailArrayOfЗаписьВНакладной members)
        ...
        /// </summary>
        public DetailArrayOfЗаписьВНакладной(IIS.KhamraevMB.Накладная fНакладная) : 
                base(typeof(ЗаписьВНакладной), ((ICSSoft.STORMNET.DataObject)(fНакладная)))
        {
        }
        
        public IIS.KhamraevMB.ЗаписьВНакладной this[int index]
        {
            get
            {
                return ((IIS.KhamraevMB.ЗаписьВНакладной)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.KhamraevMB.ЗаписьВНакладной dataobject)
        {
