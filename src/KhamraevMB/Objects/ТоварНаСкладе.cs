...
namespace IIS.KhamraevMB
{
    ...
    public class ТоварНаСкладе : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.KhamraevMB.Склад.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Склад"})]
        public virtual IIS.KhamraevMB.Склад Склад
        {
            get
            {
                ...
                IIS.KhamraevMB.Склад result = this.fСклад;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварНаСкладеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварНаСкладеE", typeof(IIS.KhamraevMB.ТоварНаСкладе));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТоварНаСкладе : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.KhamraevMB.DetailArrayOfТоварНаСкладе members)

        // *** End programmer edit section *** (IIS.KhamraevMB.DetailArrayOfТоварНаСкладе members)
        ...
        /// </summary>
        public DetailArrayOfТоварНаСкладе(IIS.KhamraevMB.Склад fСклад) : 
                base(typeof(ТоварНаСкладе), ((ICSSoft.STORMNET.DataObject)(fСклад)))
        {
        }
        
        public IIS.KhamraevMB.ТоварНаСкладе this[int index]
        {
            get
            {
                return ((IIS.KhamraevMB.ТоварНаСкладе)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.KhamraevMB.ТоварНаСкладе dataobject)
        {
