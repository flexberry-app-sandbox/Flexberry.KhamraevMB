...
namespace IIS.KhamraevMB
{
    ...
    public class Склад : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KhamraevMB.DetailArrayOfТоварНаСкладе fТоварНаСкладе;
        ...
        public virtual IIS.KhamraevMB.DetailArrayOfТоварНаСкладе ТоварНаСкладе
        {
            get
            {
                ...
                {
                    this.fТоварНаСкладе = new IIS.KhamraevMB.DetailArrayOfТоварНаСкладе(this);
                }
                IIS.KhamraevMB.DetailArrayOfТоварНаСкладе result = this.fТоварНаСкладе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СкладE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладE", typeof(IIS.KhamraevMB.Склад));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СкладL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладL", typeof(IIS.KhamraevMB.Склад));
                }
            }
        }
    }
