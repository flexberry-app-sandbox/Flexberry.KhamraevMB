...
namespace IIS.KhamraevMB
{
    ...
    public class Накладная : IIS.KhamraevMB.Документ
    {
        ...
        private IIS.KhamraevMB.СостояниеНакладной fСтатус;
        
        private string fФИОПолучателя;
        
        private IIS.KhamraevMB.Сотрудник fСотрудник;
        
        private IIS.KhamraevMB.DetailArrayOfЗаписьВНакладной fЗаписьВНакладной;
        ...
        public virtual IIS.KhamraevMB.СостояниеНакладной Статус
        {
            get
            {
                ...
                IIS.KhamraevMB.СостояниеНакладной result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.KhamraevMB.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.KhamraevMB.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.KhamraevMB.DetailArrayOfЗаписьВНакладной ЗаписьВНакладной
        {
            get
            {
                ...
                {
                    this.fЗаписьВНакладной = new IIS.KhamraevMB.DetailArrayOfЗаписьВНакладной(this);
                }
                IIS.KhamraevMB.DetailArrayOfЗаписьВНакладной result = this.fЗаписьВНакладной;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НакладнаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяE", typeof(IIS.KhamraevMB.Накладная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НакладнаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяL", typeof(IIS.KhamraevMB.Накладная));
                }
            }
        }
    }
