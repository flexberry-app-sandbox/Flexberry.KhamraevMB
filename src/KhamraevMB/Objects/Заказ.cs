...
namespace IIS.KhamraevMB
{
    ...
    [View("ЗаказL", new string[] {
            ...
            "ДатаОтгрузки as \'Дата отгрузки\'",
            "Статус as \'Статус\'"})]
    public class Заказ : IIS.KhamraevMB.Документ
    {
        ...
        private IIS.KhamraevMB.СостояниеЗаказа fСтатус;
        
        private IIS.KhamraevMB.Сотрудник fСотрудник;
        
        private IIS.KhamraevMB.DetailArrayOfСтрокаЗаказа fСтрокаЗаказа;
        ...
        public virtual IIS.KhamraevMB.СостояниеЗаказа Статус
        {
            get
            {
                ...
                IIS.KhamraevMB.СостояниеЗаказа result = this.fСтатус;
        ...
        public virtual IIS.KhamraevMB.DetailArrayOfСтрокаЗаказа СтрокаЗаказа
        {
            get
            {
                ...
                {
                    this.fСтрокаЗаказа = new IIS.KhamraevMB.DetailArrayOfСтрокаЗаказа(this);
                }
                IIS.KhamraevMB.DetailArrayOfСтрокаЗаказа result = this.fСтрокаЗаказа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказE", typeof(IIS.KhamraevMB.Заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказL", typeof(IIS.KhamraevMB.Заказ));
                }
            }
        }
    }
